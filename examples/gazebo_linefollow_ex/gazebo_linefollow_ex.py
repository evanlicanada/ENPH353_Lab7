...
if __name__ == '__main__':
    ...
    learn = True # determines if we explore or not
    ...
    for x in range(total_episodes):
        ...
        while True:
            ...
            if(learn):
                ...
                action = qlearn.policy_chooseAction(state)
        ...
        if highest_reward < cumulated_reward:
                ...
                qlearn.save_policy() # If a new highest reward is reached, save the q values as the policy

        if(x > 200 and highest_reward > 1700):
            learn = False
